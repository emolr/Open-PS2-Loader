...
void PrepareGSM(char *cmdline)
{
    ...
    static const predef_vmode_struct predef_vmode[29] = {
        ...
        {GS_INTERLACED, GS_MODE_NTSC,        GS_FRAME, makeDISPLAY(447,  2559, 0,   3,   46,  700), makeSYNCV(6,  480,  6,    26,  6,   2)},
        {GS_INTERLACED, GS_MODE_NTSC,        GS_FRAME, makeDISPLAY(447,  2559, 0,   3,   26,  700), makeSYNCV(6,  480,  6,    26,  6,   2)},
        {GS_INTERLACED, GS_MODE_NTSC,        GS_FRAME, makeDISPLAY(447,  2559, 0,   3,   46,  700), makeSYNCV(6,  480,  6,    26,  6,   1)},
        {GS_INTERLACED, GS_MODE_NTSC,        GS_FRAME, makeDISPLAY(447,  2559, 0,   3,   26,  700), makeSYNCV(6,  480,  6,    26,  6,   1)},
